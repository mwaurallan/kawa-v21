...
$sql=mysql_query("SELECT * FROM mem_savings2 WHERE m_name='".$name3."' ");


//ORDER BY m_name ASC
//'".$name3."
$qc2=mysql_query("SELECT SUM(s_amount) as amt FROM mem_savings2 WHERE m_name='".$name3."'");
$rm2=mysql_fetch_array($qc2);
$TotalAmt=$rm2['amt'];
$TotalAmt2=number_format($TotalAmt,2);


$qc3=mysql_query("SELECT s_balance FROM savings WHERE s_mem_id='$sid' ORDER BY s_id DESC");
...
$qc4=mysql_query("SELECT SUM(s_contrib) as amtc FROM mem_savings2 WHERE m_name='".$name3."'");
$rm4=mysql_fetch_array($qc4);
$TotalAmt5=$rm4['amtc'];
$TotalAmt6=number_format($TotalAmt5,2);
$dar4="Total Contribution";

$qc5=mysql_query("SELECT SUM(s_fine) as amtf FROM mem_savings2 WHERE m_name='".$name3."'");
